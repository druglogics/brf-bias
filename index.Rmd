...
```{r ss-lo-agreement-prop-grouped, fig.align='center', dpi=300, cache=TRUE, fig.cap="Parameterization and Stable State activity agreement. CASCADE 1.0 nodes are grouped based on their respective number of regulators"}
node_stats %>% 
